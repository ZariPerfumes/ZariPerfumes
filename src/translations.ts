...
export const UI_STRINGS: Translation = {
  ...
  subscribe: { en: 'Subscribe for exclusive drops, and 5% off your next order!', ar: 'اشترك للحصول على عروض حصرية، وخصم 5% على طلبك التالي!'},
  stayintheloop: { en:'Stay in the loop!', ar: 'ابقَ على اطلاع!' },
  join: { en: 'Join', ar: 'انضم' },
  aboutUsDesc: { en: 'We curate the finest local talent to bring you unique, handcrafted items that you won’t find anywhere else. Every purchase supports a local creator.', ar: 'نختار أفضل المواهب المحلية لنقدم لكم منتجات فريدة مصنوعة يدوياً لن تجدوها في أي مكان آخر. كل عملية شراء تدعم حرفيين محليين.'},
  aboutUsTitle: { en: 'Artisanal Quality, Local Heart', ar: 'جودة حرفية، بروح محلية' },
  account_menu: { en: 'Account', ar: 'الحساب' },
  ...
  location: { en: "City / Area", ar: "المدينة / المنطقة" },
  address: { en: "Full Address", ar: "العنوان بالكامل" },
  loginAction: { en: "Login", ar: "تسجيل الدخول" },
  signupAction: { en: "Create Account", ar: "إنشاء حساب" },
  sendOtp: { en: "Send Verification Code", ar: "إرسال رمز التحقق" },
  enterOtp: { en: "Enter 6-Digit Code", ar: "أدخل الرمز المكون من 6 أرقام" },
  verify: { en: "Verify & Continue", ar: "تحقق ومتابعة" },
  resendOtp: { en: "Resend Code", ar: "إعادة إرسال الرمز" },
  personalInfo: { en: "Personal Details", ar: "المعلومات الشخصية" },
  saveSettings: { en: "Save Changes", ar: "حفظ التغييرات" },
  logout: { en: "Sign Out", ar: "تسجيل الخروج" },
  forgotPassword: { en: "Forgot Password?", ar: "نسيت كلمة المرور؟" },
  passwordHint: { en: "8+ chars, 1 Uppercase, 1 Number", ar: "8 رموز، حرف كبير، ورقم" },
  recentlyViewed: {en: "Recently Viewed", ar: "تم مشاهدتها مؤخرًا" }
};