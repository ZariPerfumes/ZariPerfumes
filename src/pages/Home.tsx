    ...
    <div className="min-h-screen bg-white dark:bg-purple-950 transition-colors duration-300 overflow-x-hidden">
      ...
      <section className="relative h-162.5 flex items-center justify-center overflow-hidden">
        ...
        <div className="relative text-center text-white px-4">
          ...
          <Link to="/explore">
            <button className="bg-purple-600 text-white px-10 py-4 rounded-full font-black hover:bg-white hover:text-purple-600 transition-all shadow-2xl transform hover:scale-105 active:scale-95">
              {t('explore')}
            </button>
          </Link>
        </div>
        ...
        <section className="py-24 bg-purple-50 dark:bg-purple-900/20">
          <div className="container mx-auto px-4">
            ...
            <div className="space-y-12">
              {[workshop1, workshop2].map((ws, i) => ws?.available === 'yes' && (
                <motion.div key={i} {...fadeInUp} className="grid grid-cols-1 lg:grid-cols-2 bg-white dark:bg-purple-900/60 rounded-[40px] overflow-hidden shadow-xl border border-transparent dark:border-white/10">
                  ...
                  <div className="p-10 lg:p-16 flex flex-col justify-center">
                    ...
                    <p className="text-xl text-purple-700 dark:text-purple-300 font-black mb-6" dir="ltr">{ws.date} - {ws.time}</p>
                    ...
                    <a href={ws.link} target="_blank" rel="noopener noreferrer">
                      <button className="bg-purple-600 text-white px-10 py-4 rounded-full font-black hover:bg-purple-700 transition-all shadow-lg w-fit">
                        {t('registerNow')}
                      </button>
                    </a>
                  </div>
      ...
      <section className="py-24 bg-white dark:bg-purple-950">
        <div className="container mx-auto px-4">
          <motion.h2 {...fadeInUp} className="text-4xl font-black mb-16 text-center dark:text-white">{t('ourStores')}</motion.h2>
      ...
      <section className="py-24 bg-gray-50 dark:bg-purple-900/20">
        <div className="container mx-auto px-4">
          <motion.h2 {...fadeInUp} className="text-4xl font-black mb-16 text-center dark:text-white">{t('featuredProducts')}</motion.h2>
